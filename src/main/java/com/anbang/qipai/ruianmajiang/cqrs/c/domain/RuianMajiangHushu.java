...
public class RuianMajiangHushu implements ByteBufferAble {
	...
	public void fillByByteBuffer(ByteBuffer bb) throws Throwable {
		...
		yijiupengShu = bb.getInt();
		erbapengShu = bb.getInt();
		fengzipengShu = bb.getInt();
		yijiuankeShu = bb.getInt();
		erbaankeShu = bb.getInt();
		fengziankeShu = bb.getInt();
		yijiuminggangShu = bb.getInt();
		erbaminggangShu = bb.getInt();
		fengziminggangShu = bb.getInt();
		yijiuangangShu = bb.getInt();
		erbaangangShu = bb.getInt();
		fengziangangShu = bb.getInt();
